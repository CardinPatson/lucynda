...
int compare_file_format(char *filename,Format type){
  ...
  printf("extension du fichier %s" , extension);

  switch (type)
  {
    case P1:
      //verifie si l'extension correspond au nbre magique
      printf("extension ppm %d" , strcmp(extension , ".pbm"));
      ...
      break;
    case P2:
     printf("extension ppm %d" ,strcmp(extension , ".pgm"));
      ...
      break;
    case P3:
      printf("extension ppm %d" ,strcmp(extension , ".ppm"));
